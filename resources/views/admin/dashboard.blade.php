...
<div class="container-fluid">
    ...
    <h3 class="mb-4 text-gray-800">Admin Dashboard</h3>
            ...
            <div class="card bg-dark text-white shadow">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col">
                            <h5 class="m-0">Total Revenue Generated</h5>
                        </div>
                        <div class="col-auto">
                            <h2 class="m-0 font-weight-bold text-success">{{ number_format($totalRevenue) }} Tk</h2>
                        </div>
                    </div>
                </div>
            </div>
